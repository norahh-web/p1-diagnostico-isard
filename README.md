...
| E acceso desde el pc | no comprobado desde el pc de clase. desde la vm, con el servidor en 0.0.0.0, curl a la ip real da 200 OK | red entre el pc y la vm (sin comprobar) | sin comprobar |
